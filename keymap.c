...
[_QWERTY] = {
  ...
  {KC_ESC,  KC_A,    KC_S,    KC_D,    F(3),  KC_G,   KC_H,    KC_J,  KC_K,    KC_L,    KC_LCBR, KC_BSPC},
...
[_LOWER] = {
  ...
  {_______, KC_7,    _______, KC_4,    LCTL(KC_N), _______,   _______, RALT(KC_F), RALT(KC_G), RALT(KC_B), RALT(KC_N), _______},
