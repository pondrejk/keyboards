...
[_LOWER] = {
  {KC_TILD, KC_EXLM, KC_AT,   KC_0,    KC_DLR,  KC_5,    KC_6,    KC_LBRC,    KC_9,       KC_SCLN,    KC_RPRN,    KC_DEL},
  {KC_DEL,  KC_RBRC, KC_3,    _______, _______, _______, KC_RCBR, KC_PIPE,    RALT(KC_F), RALT(KC_G), RALT(KC_B), RALT(KC_N)},
  {_______, KC_7,    _______, KC_4,    _______, _______, _______, S(KC_NUHS), S(KC_NUBS), _______,    _______,    _______},
 ...
 * |   ;  |   +  |  |   |   š  |   $  |   %  |   &  |   *  |   !  |   í  |  =   | Bksp |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * | Del  |  ~   |      | ˇ mod| ´ mod|      | Left | Down |  Up  | Left |  '   |  \   |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      |      |  #   |      |  @   |  `   |  F12 |   ^  |  <   |   >  |      |Enter |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      |             |      | Next | Vol- | Vol+ | Play |
...
[_RAISE] = {
  ...
  {KC_DEL,  RALT(KC_A), _______,    _______, KC_EQL,     S(KC_EQL),  KC_LEFT,    KC_DOWN,    KC_UP,         KC_RGHT,      RALT(KC_QUOT), KC_NUBS},
 ...
 */
[_NUMLAYER] = {
  {_______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   _______, _______, KC_P7,   KC_P8, KC_P9,   _______, _______},
  {_______, KC_F5,   KC_F6,   KC_F7,   KC_F8,   _______, _______, KC_P4,   KC_P5, KC_P6,   _______, _______},
  {_______, KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, _______, KC_P1,   KC_P2, KC_P3,   _______, _______},
